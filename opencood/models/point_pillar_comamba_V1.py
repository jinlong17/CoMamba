...
from opencood.models.fuse_modules.mamba_V1   import MambaFusionEncoder
from opencood.models.fuse_modules.fuse_utils import regroup


class PointPillarCoMAMBAV1(nn.Module):
    def __init__(self, args):
        super(PointPillarCoMAMBAV1, self).__init__()
        ...
        self.fusion_net = MambaFusionEncoder(args['fax_fusion'])
